        ...
        <div class="row">
            ...
            <tr>
                ...
                <th>Action</th>
                      ...
                      <tbody>
            <%
             String sel="select * from tbl_musicband m inner join tbl_district d on d.district_id=m.district_id where m.band_status='2' ";
            ...
            <tr>
                ...
                <td><a href="MusicBandList-Rejected.jsp?aid=<%=rs.getString("band_id")%>">Accept</a></td>
            </tr>
            <%
                        }
            %>
