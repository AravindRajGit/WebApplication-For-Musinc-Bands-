...
<!--                                    <li><a href="albums-store.html">Albums</a></li>-->
                                    <li><a href="#">Sign Up</a>
                                        <ul class="dropdown">
                                            <li><a href="../Guest/MusicBandReg.jsp">Band</a></li>
                                            <li><a href="../Guest/MusicianReg.jsp">Musicians</a></li>
                                            <li><a href='../Guest/UserRegistration.jsp'>Users</a></li>
...
<!--                                    <li><a href="event.html">Events</a></li>
                                ...
                                <div class="login-register-cart-button d-flex align-items-center">
                                    ...
                                    <div class="login-register-btn mr-50">
                                        <a href='../Guest/LogIn.jsp' id="loginBtn">Login</a>
                                    </div>
