...
if(isMultipart)
{
   ...
   String ins="insert into tbl_musician(musician_name,musician_gender,musician_dob,musician_address,city_id,musician_contact,musician_email,artist_id,artsub_id,musician_photo,musician_username,musician_password)values('"+value[0]+"','"+value[1]+"','"+value[2]+"','"+value[3]+"','"+value[5]+"','"+value[6]+"','"+value[7]+"','"+value[8]+"','"+value[9]+"','"+fn+"','"+value[10]+"','"+value[11]+"')";
    ...
    if(status==true)
    {
      %> 
       <script type="text/javascript">
            ...
            setTimeout(function(){window.location.href='MusicianReg.jsp'},40);//40millisecend it go to next page
        </script>
     <%
    }
     }    
