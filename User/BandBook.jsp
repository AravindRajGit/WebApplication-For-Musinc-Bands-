...
<%
   ...
   if(request.getParameter("btnsubmit")!=null)
   {
       ...
       String ins="insert into tbl_bandbook(district_id,bb_location,bb_address,bb_date,bb_time,bb_facilities,user_id,band_id,bb_curdate) values('"+district+"','"+location+"','"+address+"','"+date+"','"+time+"','"+facilities+"','"+session.getAttribute("userid")+"','"+bandid+"',curdate())";
      obj.executeCommand(ins);
      //System.out.println(ins);
      //out.print(ins);
      %>
      <script>
          alert('Successfully Bookeed Troops Will be Contact You Later')
      </script>
   <%   
   }
%>
